namespace Service.Converter.WebApi.Tests
{
        ...
        : IClassFixture<DefaultTestFixture>
    {
        ...
        public TemperatureTests(DefaultTestFixture factory)
        {
            _factory = factory;
        }

        [Fact]
        public async Task Can_Convert_FahrenheitToCelsius()
        {
            string url = "v1/Temperature/FahrenheitToCelsius/80";
        ...
        [Fact]
        public async Task Can_Convert_CelsiusToFahrenheit()
        {
            string url = "v1/Temperature/CelsiusToFahrenheit/43";
