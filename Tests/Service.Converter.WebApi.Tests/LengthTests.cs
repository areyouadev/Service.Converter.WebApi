namespace Service.Converter.WebApi.Tests
{
        ...
        : IClassFixture<DefaultTestFixture>
    {
        ...
        public LengthTests(DefaultTestFixture factory)
        {
            _factory = factory;
        }

        [Fact]
        public async Task Can_Convert_MilesToKilometers()
        {
            string url = "v1/Length/MilesToKilometers/45";
        ...
        [Fact]
        public async Task Can_Convert_KilometersToMiles()
        {
            string url = "v1/Length/KilometersToMiles/230";
